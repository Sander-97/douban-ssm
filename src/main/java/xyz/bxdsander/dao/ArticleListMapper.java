...
public interface ArticleListMapper {
   ...
   int getTotalCount();
     ...
     * @return 返回记录总数
     */
    int getArticleSearchCount(String searchContent);
     ...
     */
    List<ArticleList> queryArticleByPage(int currentPage, int pageSize, String searchContent);
     ...
     * @return 记录条数
     */
    int getMyArticleSearchCount(String searchContent, int authorId);
     ...
     */
    List<ArticleList> queryMyArticleByPage(int currentPage, int pageSize, String searchContent, int authorId);
     ...
     */
     List<ArticleList> queryMyCollectionBytPage(int currentPage, int pageSize, int userId);
